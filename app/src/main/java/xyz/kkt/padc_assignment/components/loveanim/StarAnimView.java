package xyz.kkt.padc_assignment.components.loveanim;
 ...
 */
public class StarAnimView extends FrameLayout implements View.OnClickListener {
    ...
    public StarAnimView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_component_star_anim, this, true);
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        ivStar.setImageResource(isChecked ? R.drawable.ic_app_rating_24dp : R.drawable.ic_app_rating_border_star_24dp);
